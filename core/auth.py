"""Fornece suporte para o tratamento de tokens OAuth2 e autenticacao de credenciais de usuario."""
...
async def authenticate_user(email: str, password: str, db: AsyncSession) -> Optional[users_models]:
    """Retorna o usuario quando o email e senha sao validos."""
...
def _generate_token(type_token: str, life_time: timedelta, sub: str) -> str:
    """Gera um JWT assinado com o tipo e a validade requisitados."""
    payload = {}
...
def _generate_access_token(sub: str) -> str:
    """Gera um token de acesso ao portados para um uduario identificado."""
