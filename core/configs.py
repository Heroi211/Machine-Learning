"""Carrega e valida configuracoes de aplicacao das variaveis de ambiente."""
...
class Settings(BaseSettings):
    ...
    mlflow_tracking_uri: str = Field(default="sqlite:///artifacts/mlruns/mlflow.db", alidation_alias="MLFLOW_TRACKING_URI")
    mlflow_artifact_root: str = Field(default="artifacts/mlruns", alidation_alias="MLFLOW_ARTIFACT_ROOT")
